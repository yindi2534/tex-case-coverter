...
<head>
    ...
    <style>
        ...
        .card { background: #18181c; padding: 35px; border-radius: 16px; box-shadow: 0 15px 35px rgba(0,0,0,0.6); max-width: 680px; margin: auto; border: 1px solid rgba(212,175,55,0.3); }
        ...
        button { background: linear-gradient(135deg, #c5a059 0%, #f3e5ab 50%, #b38728 100%); color: #000; border: none; padding: 12px 20px; border-radius: 25px; cursor: pointer; font-weight: 700; flex: 1; }
        button:hover { transform: translateY(-2px); }
        .ad-space { background: #121215; border: 1px dashed #d4af37; padding: 15px; text-align: center; margin-bottom: 25px; color: #d4af37; border-radius: 8px; font-size: 13px; }
...
<body>
    <div class="card">
        ...
        <div style="background: linear-gradient(135deg, #ff6b00 0%, #ff8800 100%); color: #fff; padding: 20px; border-radius: 12px; text-align: center; margin: 25px 0;">
